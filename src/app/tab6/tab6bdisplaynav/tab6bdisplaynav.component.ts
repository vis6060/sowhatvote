...
export class Tab6bdisplaynavComponent implements OnInit {
  ...
  async putindextab1B() {
    ...
    Cache.setItem('tab6index', '1', { expires: expiration +900000 }); //expires after 15minutes, time is in ms.
  }
  ...
  async gethompage1Binitialize() {
    ...
    API.get("datingapitest4", "/itemapitab6Bdup/m", paramsp1).then(response1 =>
