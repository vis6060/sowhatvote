...
export class Tab6cdisplaynavComponent implements OnInit {
  ...
  async putindextab1B() {
    ...
    const paramsp2 = {body: {userid: user.attributes.sub, tab1index:0, tab3index:0, tab6index:2}} //place itemid in index1 position of tab1
  ...
  async gethompage1Binitialize() {
    ...
    API.get("datingapitest4", "/itemapitab6C/m", paramsp1).then(response1 =>
